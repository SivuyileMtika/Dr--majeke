        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex overflow-x-auto gap-4 pb-2 md:pb-0 md:grid md:grid-cols-3 md:gap-10 snap-x snap-mandatory">
            <div className="flex-shrink-0 w-72 md:w-auto snap-start bg-gradient-to-br from-orange-50 to-orange-100 p-6 md:p-10 rounded-3xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-3 border-2 border-orange-200">
              ...
              <h4 className="text-base md:text-xl lg:text-2xl font-bold text-gray-900 mb-3 md:mb-6">General Checkups</h4>
              <p className="text-gray-700 text-sm md:text-lg leading-relaxed">Comprehensive health assessments, routine screenings, and preventive care to keep you in optimal health.</p>
            </div>
            <div className="flex-shrink-0 w-72 md:w-auto snap-start bg-gradient-to-br from-gray-50 to-gray-100 p-6 md:p-10 rounded-3xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-3 border-2 border-gray-200">
              <div className="bg-gradient-to-r from-gray-700 to-gray-800 w-14 h-14 md:w-20 md:h-20 rounded-full flex items-center justify-center mb-4 md:mb-8 shadow-lg">
                <Shield className="h-7 w-7 md:h-10 md:w-10 text-white" />
              </div>
              <h4 className="text-base md:text-xl lg:text-2xl font-bold text-gray-900 mb-3 md:mb-6">Family Medicine</h4>
              <p className="text-gray-700 text-sm md:text-lg leading-relaxed">Complete healthcare for all family members, from pediatric care to geriatric medicine and everything in between.</p>
            </div>
            <div className="flex-shrink-0 w-72 md:w-auto snap-start bg-gradient-to-br from-orange-50 to-orange-100 p-6 md:p-10 rounded-3xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-3 border-2 border-orange-200">
              <div className="bg-gradient-to-r from-orange-500 to-orange-600 w-14 h-14 md:w-20 md:h-20 rounded-full flex items-center justify-center mb-4 md:mb-8 shadow-lg">
                <Stethoscope className="h-7 w-7 md:h-10 md:w-10 text-white" />
              </div>
              <h4 className="text-base md:text-xl lg:text-2xl font-bold text-gray-900 mb-3 md:mb-6">Chronic Care Management</h4>
              <p className="text-gray-700 text-sm md:text-lg leading-relaxed">Ongoing management of chronic conditions like diabetes, hypertension, and heart disease with personalized treatment plans.</p>
            </div>
          </div>
        </div>
      </section>
